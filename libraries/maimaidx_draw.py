...
class DrawBest:
    ...
    async def draw(self):
        ...
        self._tb.draw(847, 295, 28, f'LV{self.level} score list, No.{self.page} page.', (0, 0, 0, 255), 'mm', 3, (255, 255, 255, 255))
...
async def generate_list(qqid: Optional[int] = None, username: Optional[str] = None, level: Optional[str] = None, page: Optional[int] = None):
    try:
