...
class DrawBest:
    ...
    def __init__(self, UserInfo: UserInfo, qqId: Optional[Union[int, str]] = None) -> None:
        ...
        # 选出ap和app
        self.sdBest = [i for i in self.sdBest if i.fc == 'ap' or i.fc == 'app']
        self.dxBest = [i for i in self.dxBest if i.fc == 'ap' or i.fc == 'app']
    ...
    async def draw(self):
        ...
        self._tb.draw(847, 295, 27, f'(AP)B35: {sdrating} + B15: {dxrating} = {self.Rating}', (0, 0, 0, 255), 'mm', 3, (255, 255, 255, 255))
